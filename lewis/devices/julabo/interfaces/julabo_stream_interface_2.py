...
class JulaboStreamInterfaceV2(StreamInterface):
    ...
    commands = {
        ...
        Cmd('set_set_point', r'^OUT_SP_00 ([0-9]*\.?[0-9]+)$', argument_mappings=(float,)),
        ...
        Cmd('set_internal_p', r'^OUT_PAR_06 ([0-9]*\.?[0-9]+)$', argument_mappings=(float,)),
        ...
        Cmd('set_external_p', r'^OUT_PAR_09 ([0-9]*\.?[0-9]+)$', argument_mappings=(float,)),
