...
class JulaboStreamInterfaceV1(StreamAdapter):
    ...
    commands = {
        ...
        Var('temperature_high_limit', read_pattern='^IN_SP_01$', doc='The high limit - usually set in the hardware.'),
        Var('temperature_low_limit', read_pattern='^IN_SP_02$', doc='The low limit - usually set in the hardware.'),
